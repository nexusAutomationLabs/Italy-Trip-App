    ...
    <div className="min-h-svh flex flex-col lg:grid lg:grid-cols-2">
      ...
      <div className="flex-1 flex items-center justify-center bg-background px-6 py-10 lg:py-0">
        <div className="w-full max-w-sm mx-auto">
          <h1 className="font-heading text-3xl lg:text-4xl font-bold italic text-foreground">Welcome Back</h1>
          <p className="mt-2 mb-8 text-muted-foreground text-sm">Sign in to see what the group has planned.</p>
