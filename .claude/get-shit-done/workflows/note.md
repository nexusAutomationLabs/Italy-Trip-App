...
- **Global scope**: `/Users/adamdalton/Documents/Coding Projects/Italy Trip App/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/adamdalton/Documents/Coding Projects/Italy Trip App/.claude/notes/`)
...
2. Glob `/Users/adamdalton/Documents/Coding Projects/Italy Trip App/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/adamdalton/Documents/Coding Projects/Italy Trip App/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/adamdalton/Documents/Coding Projects/Italy Trip App/.claude/notes/` — works in any directory
